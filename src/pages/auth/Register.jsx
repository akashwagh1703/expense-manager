...
const FarmerSettingsPage = () => {
    ...
    const handleSave = async () => {
        try {
            ...
            const data = await response.json();
            if (data.success) {
                toast.success("Settings saved!"); // Show success notification
            } else {
                toast.error("Failed to save settings!"); // Show error notification
            }
        } catch (error) {
            console.error('Error saving settings:', error);
            toast.error("Error saving settings!"); // Show error notification
        }
    };
